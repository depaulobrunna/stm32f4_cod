...
int main(void){
	...
	ADC2->CR1 |= ADC_CR1_RES_1;//ADC 12 BITS
	ADC2->CR1 &= ~ADC_CR1_AWDEN;
	ADC2->SQR1 = 0 << ADC_SQR1_L_Pos;//N DE CONV = 1
	ADC2->SQR1 = 1 << ADC_SQR1_SQ13_Pos;//SEQ DO CANAL, JOGA NO REGISTRADOR RESPECTIVO O NUMERO DA SUA ORDEM DE LEITURA
	ADC2->SMPR1 = 8 << ADC_SMPR1_SMP13_Pos;//SAMPLE TIME 84 CYCLES
	ADC2->CR2 |= ADC_CR2_ADON;
